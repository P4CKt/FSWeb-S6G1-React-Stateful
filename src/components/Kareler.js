...
export default function Kareler(props) {
  ...
  const [aktifKareler,setAktifkareler] = useState(null);
  ...
  const AktifEt = id => {
    ...
    setAktifkareler(id ==aktifKareler ? null : id)
      ...
      <div className='squares'>
        {
          ...
          // bunu anlamadım ama gerçekten çalışıyor :)
